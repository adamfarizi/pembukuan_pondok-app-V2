    ...
    public function create(Request $request)
    {
        try {
            ...
            $pendaftaran = Pendaftaran::create([
                ...
                'tempat_lahir_pendaftar' => $request->tempat_lahir_pendaftar,
                'tanggal_lahir_pendaftar' => $request->tanggal_lahir_pendaftar,
                ...
                'tingkatan_pendaftar' => $request->tingkatan_pendaftar,
