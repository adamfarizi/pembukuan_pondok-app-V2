...
class AdminDaftarUlangController extends Controller
{
    ...
    public function add_cicilan(Request $request)
    {
        ...
        if ($total_bayar > $pembayaran->jumlah_pembayaran) {
            ...
            return redirect()->route('daftar_ulang')->with('success', 'Pembayaran daftar ulang Lunas, kembalian Rp' . $kembalian);
        }
        ...
        switch (true) {
            ...
            default:
                ...
                return redirect()->route('daftar_ulang')->with('success', 'Data cicilan berhasil ditambahkan');
        }
    }
    public function delete_cicilan(Request $request, $id_cicilan_pembayarans)
    {
        ...
        return redirect()->route('daftar_ulang')->with('success', 'Pembayaran cicilan daftar ulang dibatalkan');
    }
