            ...
            <form id="updateForm" method="post">
                ...
                <div class="modal-body">
                    <div class="form-group">
                        ...
                        <select class="form-control" name="nama_santri" id="nama_santri" required>
                            <option value="">Pilih Nama Santri</option>
                            @foreach ($pembayarans as $pembayaran)
                                <option value="{{ $pembayaran->santri->id_santri }}">{{ $pembayaran->santri->nama_santri }}
                                </option>
                            @endforeach
                        </select>
                    </div>
...
<div class="modal fade" id="deleteModal{{ $daftar_ulang->id_pembayaran }}" tabindex="-1" role="dialog"
    ...
    <div class="modal-dialog modal-dialog-centered" role="document">
        <div class="modal-content">
            ...
            <form action="{{ url('/pembayaran/daftar_ulang/delete/' . $daftar_ulang->id_pembayaran) }}" id="deleteForm"
                method="post">
                @csrf
                @method('DELETE')
                    ...
                    render: function (data, type, full, meta) {
                        if (full.status_pembayaran == 'belum_lunas') {
                            ...
                            return '<div class="d-flex flex-column">' + 
                                ...
                                '<a class="badge badge-pill badge-success p-2 mt-2" title="Info cicilan" href="/admin/daftar_ulang/cicilan/' + full
                                .id_pembayaran + '/bayar">' +
