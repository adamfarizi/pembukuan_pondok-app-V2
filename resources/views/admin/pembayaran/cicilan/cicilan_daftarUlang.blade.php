                    ...
                    <div class="iq-card">
                        <div class="iq-card-header d-flex justify-content-between">
                            <div class="iq-header-title">
                                ...
                                <p class="text-dark">Daftar Ulang Tahun Ajaran {{ $currentTahun }}</p>
                            </div>
                        ...
                        <div class="d-flex">
                            <div class="col-lg-4">
                                <table class="table table-borderless mt-3">
                                    <tbody>
                                        <tr>
                                            <th class="pb-0 pt-1">Biaya Daftar Ulang</th>
    ...
    <div class="modal fade" id="exampleModalCenter" tabindex="-1" role="dialog"
        ...
        <div class="modal-dialog modal-dialog-centered" role="document">
            <div class="modal-content">
                ...
                <form action="{{ url('/admin/pembayaran/daftar_ulang/cicilan/add') }}" id="updateForm" method="post">
                    @csrf
        ...
        <div class="modal fade" id="deleteModal{{ $data->id_cicilan_pembayarans }}" tabindex="-1" role="dialog"
            ...
            <div class="modal-dialog modal-dialog-centered" role="document">
                <div class="modal-content">
                    ...
                    <form action="{{ url('/admin/pembayaran/daftar_ulang/cicilan/delete/' . $data->id_cicilan_pembayarans) }}"
