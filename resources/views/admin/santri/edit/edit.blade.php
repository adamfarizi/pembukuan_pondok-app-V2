        ...
        <div class="container-fluid">
            <div class="iq-card">
                ...
                <div class="iq-card-body">
                    ...
                    <form action="{{ url('/admin/santri/edit/' . $santri->id_santri . '/action') }}" method="post"
                        enctype="multipart/form-data">
                        @method('PUT')
                        @csrf
                        <div class="modal-body">
                            <h5 class="mb-2">IDENTITAS SANTRI</h5>
                                ...
                                <div class="col mb-3">
                                    ...
                                    <select class="form-control" name="status_santri" id="status_santri" required>
                                        <option value="mukim" @if ($santri->status_santri == 'mukim') selected @endif>Mukim
                                            (Tinggal)</option>
                                        <option value="tidak_mukim" @if ($santri->status_santri == 'tidak_mukim') selected @endif>Tidak
                                            Mukim (Pulang)</option>
                                    </select>
                                </div>
                                <div class="col mb-3">
                                    ...
                                    <select class="form-control" name="tingkatan" id="tingkatan" required>
                                        <option value="1" @if ($santri->tingkatan == '1') selected @endif>Kelas 1
                                        </option>
                                        <option value="2" @if ($santri->tingkatan == '2') selected @endif>Kelas 2
                                        </option>
                                        <option value="3" @if ($santri->tingkatan == '3') selected @endif>Kelas 3
                                        </option>
                                        <option value="4" @if ($santri->tingkatan == '4') selected @endif>Kelas 4
                                        </option>
                                        <option value="5" @if ($santri->tingkatan == '5') selected @endif>Kelas 5
                                        </option>
                                        <option value="6" @if ($santri->tingkatan == '6') selected @endif>Kelas 6
                                        </option>
                                        <option value="1_TSA" @if ($santri->tingkatan == '1_TSA') selected @endif>1 TSA
                                        </option>
                                        <option value="2_TSA" @if ($santri->tingkatan == '2_TSA') selected @endif>2 TSA
                                        </option>
                                        <option value="3_TSA" @if ($santri->tingkatan == '3_TSA') selected @endif>3 TSA
                                        </option>
                                        <option value="pengurus" @if ($santri->tingkatan == 'pengurus') selected @endif>
                                            Pengurus</option>
                                    </select>
                                </div>
                            </div>
                                ...
                                <div class="col">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" id="tempat_lahir_santri"
                                            name="tempat_lahir_santri" value="{{ $santri->tempat_lahir_santri }}"
                                ...
                                <div class="col">
                                    <div class="form-group">
                                        ...
                                        <input type="date" class="form-control" id="tanggal_lahir_santri"
                                            name="tanggal_lahir_santri" value="{{ $santri->tanggal_lahir_santri }}"
                                            required>
                                    </div>
                                </div>
                                <div class="col">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-3 mb-3">
                                    ...
                                    <input type="text" class="form-control" id="kab_kota" name="kab_kota"
                                        placeholder="Kabupaten/Kota" value="{{ $santri->kab_kota }}">
                                </div>
                                <div class="col-md-3 mb-3">
                                    <label for="provinsi">Provinsi <span class="text-danger">*</span></label>
                                    <input type="text" class="form-control" id="provinsi" name="provinsi"
                                        placeholder="Provinsi" value="{{ $santri->provinsi }}">
                                </div>
                                <div class="col-md-3 mb-3"">
                                    <label for="kode_pos">Kode Pos <span class="text-danger">*</span></label>
                                    <input type="text" class="form-control" id="kode_pos" name="kode_pos"
                                        placeholder="Kode Pos" value="{{ $santri->kode_pos }}">
                                </div>
                            </div>
                            <div class="row">
                                <div class="col">
                            ...
                            <div class="row">
                                <div class="col-md-6 mb-3">
                                    ...
                                    <input type="number" class="form-control" id="jumlah_saudara_kandung"
                                        ...
                                        value="{{ $santri->jumlah_saudara_kandung }}">
                                </div>
                                <div class="col-md-6 mb-3">
                                    <label for="anak_ke">Anak ke</label>
                                    <input type="number" class="form-control" id="anak_ke" name="anak_ke"
                                        placeholder="Anak ke" value="{{ $santri->anak_ke }}">
                                </div>
                            </div>
                            <h5 class="mt-2 mb-2">IDENTITAS ORANG TUA SANTRI</h5>
                            <div class="form-group">
                                ...
                                <div class="col">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" id="pendidikan_ayah"
                                            name="pendidikan_ayah" value="{{ $santri->pendidikan_ayah }}"
                                ...
                                <div class="col">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" id="pendidikan_ibu"
                                            name="pendidikan_ibu" value="{{ $santri->pendidikan_ibu }}"
                                ...
                                <div class="col">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" id="pekerjaan_ayah"
                                            name="pekerjaan_ayah" value="{{ $santri->pekerjaan_ayah }}"
                                ...
                                <div class="col">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" id="pekerjaan_ibu"
                                            name="pekerjaan_ibu" value="{{ $santri->pekerjaan_ibu }}"
                                ...
                                <div class="col">
                                    <div class="form-group">
                                        ...
                                        <input type="number" class="form-control" id="pendapatan_ayah_perbulan"
                                            name="pendapatan_ayah_perbulan"
                                            value="{{ $santri->pendapatan_ayah_perbulan }}"
                                            placeholder="Masukkan Pendapatan Perbulan Ayah">
                                    </div>
                                </div>
                                <div class="col">
                                    <div class="form-group">
                                        ...
                                        <input type="number" class="form-control" id="pendapatan_ibu_perbulan"
                                            name="pendapatan_ibu_perbulan" value="{{ $santri->pendapatan_ibu_perbulan }}"
                                            placeholder="Masukkan Pendapatan Perbulan Ibu">
                                    </div>
                                </div>
                            </div>
                            <h5 class="mt-2 mb-2">IDENTITAS WALI SANTRI</h5>
                            <div class="row">
                                <div class="col">
                                    <div class="form-group">
                                        <div class="mb-3">
                                            ...
                                            <input type="text" class="form-control" id="nama_wali" name="nama_wali"
                                                ...
                                                value="{{ $wali ? $wali->nama_wali ?? '' : '' }}">
                                        </div>
                                        <div class="mb-3">
                                            <label for="no_identitas_wali">No. Identitas Wali (KTP/SIM) <span
                                                    class="text-danger">*</span></label>
                                            <input type="text" class="form-control" id="no_identitas_wali"
                                                name="no_identitas_wali" placeholder="Masukkan No Identitas Wali Santri"
                                                value="{{ $wali ? $wali->no_identitas_wali ?? '' : '' }}">
                                        </div>
                                        <div class="row">
                                            <div class="col">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" class="form-control" id="tempat_lahir_wali"
                                                        ...
                                                        value="{{ $wali ? $wali->tempat_lahir_wali ?? '' : '' }}"
                                                        placeholder="contoh. Madiun" required>
                                                </div>
                                            </div>
                                            <div class="col">
                                                <div class="form-group">
                                                    ...
                                                    <input type="date" class="form-control" id="tanggal_lahir_wali"
                                                        ...
                                                        value="{{ $wali ? $wali->tanggal_lahir_wali ?? '' : '' }}"
                                                        required>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="row">
                                            <div class="col-md-3 mb-3">
                                                ...
                                                <input type="number" class="form-control" id="rt_wali" name="rt_wali"
                                                    placeholder="RT" value="{{ $wali ? $wali->rt_wali ?? '' : '' }}">
                                            </div>
                                            <div class="col-md-3 mb-3">
                                                <label for="rw_wali">RW <span class="text-danger">*</span></label>
                                                <input type="number" class="form-control" id="rw_wali" name="rw_wali"
                                                    placeholder="RW" value="{{ $wali ? $wali->rw_wali ?? '' : '' }}">
                                            </div>
                                            <div class="col-md-3 mb-3">
                                                <label for="dusun_wali">Dusun <span class="text-danger">*</span></label>
                                                <input type="text" class="form-control" id="dusun_wali"
                                                    name="dusun_wali" placeholder="Dusun"
                                                    value="{{ $wali ? $wali->dusun_wali ?? '' : '' }}">
                                            </div>
                                            <div class="col-md-3 mb-3">
                                                <label for="desa_wali">Desa <span class="text-danger">*</span></label>
                                                <input type="text" class="form-control" id="desa_wali"
                                                    name="desa_wali" placeholder="Desa"
                                                    value="{{ $wali ? $wali->desa_wali ?? '' : '' }}">
                                            </div>
                                            <div class="col-md-3 mb-3">
                                                <label for="kecamatan_wali">Kecamatan <span
                                                        class="text-danger">*</span></label>
                                                <input type="text" class="form-control" id="kecamatan_wali"
                                                    name="kecamatan_wali" placeholder="Kecamatan"
                                                    value="{{ $wali ? $wali->kecamatan_wali ?? '' : '' }}">
                                            </div>
                                            <div class="col-md-3 mb-3">
                                                <label for="kab_kota_wali">Kabupaten/Kota <span
                                                        class="text-danger">*</span></label>
                                                <input type="text" class="form-control" id="kab_kota_wali"
                                                    name="kab_kota_wali" placeholder="Kabupaten/Kota"
                                                    value="{{ $wali ? $wali->kab_kota_wali ?? '' : '' }}">
                                            </div>
                                            <div class="col-md-3 mb-3">
                                                <label for="provinsi_wali">Provinsi <span
                                                        class="text-danger">*</span></label>
                                                <input type="text" class="form-control" id="provinsi_wali"
                                                    name="provinsi_wali" placeholder="Provinsi"
                                                    value="{{ $wali ? $wali->provinsi_wali ?? '' : '' }}">
                                            </div>
                                            <div class="col-md-3 mb-3">
                                                <label for="kode_pos_wali">Kode Pos <span
                                                        class="text-danger">*</span></label>
                                                <input type="text" class="form-control" id="kode_pos_wali"
                                                    name="kode_pos_wali" placeholder="Kode Pos"
                                                    value="{{ $wali ? $wali->kode_pos_wali ?? '' : '' }}">
                                            </div>
                                        </div>
                                        <div class="row">
                                            <div class="col-md-6 mb-3">
                                                <label for="no_hp_wali">No Hp Wali <span
                                                        class="text-danger">*</span></label>
                                                <input type="text" class="form-control" id="no_hp_wali"
                                                    name="no_hp_wali" placeholder="Masukkan No Hp Wali Santri"
                                                    value="{{ $wali ? $wali->no_hp ?? '' : '' }}">
                                            </div>
                                            <div class="col-md-6 mb-3">
                                                <label for="email_wali">Email Wali<span
                                                        class="text-danger">*</span></label>
                                                <input type="email" class="form-control" id="email_wali"
                                                    name="email_wali" placeholder="Masukkan Email Wali Santri"
                                                    value="{{ $wali ? $wali->email ?? '' : '' }}">
                                            </div>
                                        </div>
                                        <div class="mb-3">
                                            <label for="status_wali">Status Wali Sebagai <span
                                                    class="text-danger">*</span></label>
                                            <select class="form-control" name="status_wali" id="status_wali" required>
                                                <option value="Ayah Kandung"
                                                    @if ($wali && $wali->status_wali == 'Ayah Kandung') selected @endif>Ayah Kandung
                                                </option>
                                                <option value="Ibu Kandung"
                                                    @if ($wali && $wali->status_wali == 'Ibu Kandung') selected @endif>Ibu Kandung</option>
                                                <option value="Paman" @if ($wali && $wali->status_wali == 'Paman') selected @endif>
                                                    Paman</option>
                                                <option value="Bibi" @if ($wali && $wali->status_wali == 'Bibi') selected @endif>
                                                    Bibi</option>
                                                <option value="Lainnya"
                                                    @if ($wali && $wali->status_wali == 'Lainnya') selected @endif>Lainnya</option>
                                            </select>
                                        </div>
                                        <div class="row">
                                            <div class="col-md-4">
                                                ...
                                                <input type="text" class="form-control" id="pendidikan_wali"
                                                    name="pendidikan_wali" placeholder="Pendidikan"
                                                    value="{{ $wali ? $wali->pendidikan_wali ?? '' : '' }}">
                                            </div>
                                            <div class="col-md-4">
                                                <label for="pekerjaan_wali">Pekerjaan Wali</label>
                                                <input type="text" class="form-control" id="pekerjaan_wali"
                                                    name="pekerjaan_wali" placeholder="Pekerjaan"
                                                    value="{{ $wali ? $wali->pekerjaan_wali ?? '' : '' }}">
                                            </div>
                                            <div class="col-md-4">
                                                <label for="pendapatan_wali_perbulan">Pendapatan Perbulan Wali</label>
                                                <input type="number" class="form-control" id="pendapatan_wali_perbulan"
                                                    name="pendapatan_wali_perbulan" placeholder="Pendapatan Perbulan"
                                                    value="{{ $wali ? $wali->pendapatan_wali_perbulan ?? '' : '' }}">
                                            </div>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            <h5 class="mt-2 mb-2">BERKAS SANTRI</h5>
                            <div class="row">
                                <div class="col">
                                    <div class="form-group">
                                        <label for="ktp_santri">KTP Santri <span class="text-danger">*</span> <span
                                                class="text-secondary">(Masukkan ktp orang tua / wali jika tidak
                                                ada)</span></label>
