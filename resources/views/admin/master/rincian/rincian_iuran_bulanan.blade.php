            ...
            <div class="navbar-breadcrumb">
                ...
                <nav aria-label="breadcrumb">
                    <ul class="breadcrumb">
                        ...
                        <li class="breadcrumb-item active" aria-current="page">Rincian Iuran Bulanan</li>
                    </ul>
                </nav>
            </div>
            {{-- Logo Kanan --}}
                    ...
                    <div class="modal-body">
                        ...
                        <div class="form-group">
                            ...
                            <select class="form-control" id="jenis_pembayaran" name="jenis_pembayaran" required>
                                ...
                                <option selected="" value="iuran">Iuran Bulanan</option>
                            </select>
                        </div>
                        {{-- Jenis Santri --}}
                        <div class="form-group">
