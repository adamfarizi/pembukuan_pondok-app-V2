            ...
            <div class="navbar-breadcrumb">
                ...
                <nav aria-label="breadcrumb">
                    <ul class="breadcrumb">
                        ...
                        <li class="breadcrumb-item active" aria-current="page">Rincian Daftar Baru</li>
                    </ul>
                </nav>
            </div>
            {{-- Logo Kanan --}}
...
@section('content')
                    ...
                    <div class="modal-body">
                        ...
                        <div class="form-group">
                            ...
                            <select class="form-control" id="jenis_pembayaran" name="jenis_pembayaran" required>
                                ...
                                <option selected="" value="pendaftaran_baru">Pendaftaran Baru</option>
                                <option value="pendaftaran_ulang">Pendaftaran Ulang</option>
    ...
    @foreach ($pendaftaran_baru as $data)
