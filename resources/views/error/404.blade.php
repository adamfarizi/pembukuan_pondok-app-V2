...
<body>
    ...
    <div class="wrapper">
        <div class="text-center">
            <img src="{{ asset('images/local/404.png') }}" width="450px" class="img-fluid" alt="Page Not Found">
            <h3 class="">Oops! Sepertinya Anda telah tersesat</h3>
            <h4 class="mb-5">Halaman yang Anda cari tidak ada di sini</h4>
            <a type="button" href="javascript:history.back()" class="btn btn-primary">Kembali</a>
            <br>
        </div>
        <div class="mt-5 text-center">
            &copy; Copyright <strong><span>Al-Huda</span></strong>. All Rights Reserved
        </div>
    </div>
    <!-- Optional JavaScript -->
