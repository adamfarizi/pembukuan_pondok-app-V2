            ...
            <div class="row">
                <div class="col">
                    <div class="card">
                        ...
                        <div class="card-body">
                            <div class="card p-4 form-step mb-5" id="step-2"
                                ...
                                <div class="card-body row">
                                    <div class="col-lg-6">
                                        ...
                                        <p class="fw-bold">Berikut adalah daftar akun pembayaran yang dapat Anda gunakan:
                                        </p>
                                        <ul>
                                            @foreach ($guest->rekening as $rekening)
                                                <li>{{ $rekening->rekening }}</li>
                                            @endforeach
                                    ...
                                    <div class="col-lg-6">
                                        <div class="text-center align-items-center">
                                            <img src="{{ asset('images/pondok/asset5.png') }}" alt=""
                                                class="img-fluid" style="height: 45vh;">
                                        </div>
                                    </div>
                                </div>
                            </div>
                            <div class="px-3">
                                <form action="{{ url('/donasi/create') }}" method="post" enctype="multipart/form-data">
                                    @csrf
                                    <div class="mb-3">
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <input type="number" class="form-control" id="jumlah_pemasukan"
                                            name="jumlah_pemasukan" value="" required>
                                    </div>
                                    <div class="mb-3">
