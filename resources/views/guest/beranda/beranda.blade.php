        ...
        <div class="row">
            <div class="col-lg-6">
                ...
                <div class="row px-5">
                    ...
                    <div class="col-lg-4">
                        <a class="btn btn-link d-inline-flex align-items-center" type="button" href="{{ url('/donasi') }}"
                ...
                <div class="col-md-6">
                    ...
                    <div class="row mt-5">
                        ...
                        <div class="col">
                            <div class="card">
                                <div class="card-body p-navy pb-0">
                                    <h3 class="fw-bold">{{ $total_guru }} <span class="ms-2"><i
                                                class="bi bi-people-fill"></i></span></h3>
                                    <p>Tenaga Pendidik</p>
                                </div>
                            </div>
            ...
            <div class="container mt-5 p-5 pb-0">
                    ...
                    <div class="col">
                        <div class="row p-3" style="background-color: #dbeefc; border-radius:15px;">
                            ...
                            <div class="col">
                                ...
                                <p>Pondok pesantren merupakan lembaga pendidikan yang fokus pada pendalaman ilmu agama
                                    Islam.
                                    Para santri diajarkan Al-Qur'an, hadis, fiqh, akhlak, dan berbagai cabang ilmu agama
                                    lainnya. Hal ini memungkinkan para santri untuk mendapatkan pemahaman yang mendalam
                                    tentang
                        ...
                        <div class="row p-3" style="background-color: #dbeefc; border-radius:15px;">
                            ...
                            <div class="col">
                                ...
                                <p>Di pondok pesantren, para santri tinggal dan belajar secara mandiri di lingkungan yang
                                    terstruktur, mengembangkan kemandirian, tanggung jawab, dan kepemimpinan melalui
                                    kegiatan
                                    sehari-hari.
                                </p>
                            </div>
                    ...
                    <div class="col ms-2">
                        <div class="row p-3" style="background-color: #dbeefc; border-radius:15px;">
                            ...
                            <div class="col">
                                ...
                                <p>Pondok pesantren menanamkan nilai-nilai moral dan etika yang tinggi kepada para
                                    santrinya,
                                    membentuk individu yang jujur, disiplin, bertanggung jawab, dan menghormati sesama
                                    manusia.
                                </p>
                            </div>
                        </div>
                ...
                <div class="row p-navy mb-4 justify-content-between">
                    <div class="col me-2">
                        <div class="row p-3" style="background-color: #dbeefc; border-radius:15px;">
                            <div class="col-4 text-center align-self-center">
                                <img src="{{ asset('images/pondok/content-writing.png') }}" alt=""
                                    width="80">
                            </div>
                            <div class="col">
                    ...
                    <div class="carousel-inner" style="border-radius: 15px;">
                        @foreach ($imageNames as $index => $imageName)
                            <div class="carousel-item {{ $index == 0 ? 'active' : '' }}">
                                <img src="{{ asset('gambar_pondok/' . $imageName) }}"
                                    class="d-block w-100 img-fluid" alt="{{ $imageName }}"
                    ...
                    <div class="col">
                        ...
                        <div class="row mb-2">
                            <div class="col row">
                                ...
                                <div class="col">{{ $guest->lokasi }}</div>
                            </div>
                        </div>
                        <div class="row mb-2">
                            <div class="col row">
                                <div class="col-1 p-navy"><i class="bi bi-telephone-fill"></i></div>
                                <div class="col">{{ $guest->no_tlp }}</div>
                            </div>
                        </div>
                        <div class="row mb-2">
                            <div class="col row">
                        ...
                        <div class="row mt-4 mb-2">
                            ...
                            <div class="col-2 row">
                                <div class="col">
                                    <a class="icon-link p-navy" href={{ 'https://www.instagram.com/' .$guest->instagram }} style="font-size: 25px">
                            ...
                            <div class="col-2 row">
                                <div class="col">
                                    <a class="icon-link p-navy" href={{ $guest->youtube }} style="font-size: 25px">
                            ...
                            <div class="col-2 row">
                                <div class="col">
                                    <a class="icon-link p-navy" href={{ $guest->facebook }} style="font-size: 25px">
